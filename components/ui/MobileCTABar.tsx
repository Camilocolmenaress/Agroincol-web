...
// Barra fija inferior solo-móvil con la acción de conversión #1: WhatsApp.
...
export default function MobileCTABar() {
  return (
    ...
    // pointer-events-none en el contenedor deja ver/tocar la página en los huecos; el botón reactiva el toque.
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-40 px-4 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] md:hidden">
      <div className="pointer-events-auto mx-auto flex max-w-md gap-3">
        ...
        >
          <MessageCircle size={18} fill="white" /> Escríbenos por WhatsApp
        </a>
      </div>
    </div>
  );
