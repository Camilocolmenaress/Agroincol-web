...
// Barra fija inferior solo-móvil con las acciones de conversión: WhatsApp (primaria)
// y llamada (secundaria). Siempre visible al hacer scroll.
    ...
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-40 px-4 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] md:hidden">
      <div className="pointer-events-auto mx-auto flex max-w-md gap-3">
        ...
        <a
          ...
          className="flex shrink-0 items-center justify-center gap-2 rounded-2xl bg-brand-green px-5 py-3.5 font-heading font-semibold text-white shadow-premium ring-1 ring-white/10 transition-transform active:scale-[0.97] active:bg-brand-green-dark"
