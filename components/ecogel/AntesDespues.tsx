  ...
  return (
    <section className="container-custom mt-10">
      ...
      <div className="mt-4 grid grid-cols-2 gap-3">
        <div>
          <Marcador etiqueta="Antes" medidas="1200×1200" src={antes} alt="Cocina con cucarachas, antes" />
          <p className="mt-1 text-center text-body-sm font-semibold text-brand-black/70">Antes</p>
        </div>
        <div>
          <Marcador etiqueta="Después (día 7)" medidas="1200×1200" src={despues} alt="La misma cocina, día 7" />
